...
def main():
    ...
    model_name = f"Ret{Ret}_flow-reconstruction_nosrgan_yp{yp_flow:03d}_subsampling-{subsampling_lr:02d}_wall-channels-{channels}"
...
def model_predictor():
    ...
    inputs = keras.Input(shape=(channels, int(nz / subsampling_lr), int(nx/ subsampling_lr)), name='high-res-input')
