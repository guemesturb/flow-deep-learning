...
def main():
    ...
    for l in predictor.layers:
        predictor.get_layer(l.name).trainable = True
    start_time = time.time()
    model_name = f"Ret{Ret}_retraining-flow-reconstruction_yp{yp_flow:03d}_subsampling-{subsampling_lr:02d}_wall-channels-{channels}_predictor.tf"
