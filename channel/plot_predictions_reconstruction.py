...
def main():
    ...
    fig.savefig(f'figs/Ret{Ret}_flow-reconstruction_instantaneous-field_yp{yp_flow:03d}_subsamplig_{subsampling_lr:02d}_wall-channels-{channels}.pdf', dpi=600)
