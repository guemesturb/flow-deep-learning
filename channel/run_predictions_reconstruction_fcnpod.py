...
def main():
    ...
    model_name = f"{models_path}Ret{Ret}_flow-reconstruction_nosrgan_yp{yp_flow:03d}_subsampling-{subsampling_lr:02d}_wall-channels-{channels}_predictor.tf"
    ...
    filename = f"{prediction_path}/Ret{Ret}_flow-reconstruction_nosrgan_predictions_yp{yp_flow:03d}_subsampling-{subsampling_lr:02d}_wall-channels-{channels}.npz" 
